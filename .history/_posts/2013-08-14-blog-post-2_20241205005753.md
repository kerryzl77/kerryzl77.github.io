...
This post introduces an end-to-end revenue management approach base on Maximum Likelihood Estimate (MLE) and Multinomial Choice Model (MNL). A simple application on a 400+ Airbnb listings dataset at Albany, New York is presented. 
