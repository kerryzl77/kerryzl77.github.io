...
<figure>
  <img src="{{ '/images/LinearRegression.png' | relative_url }}" alt="Linear regression equation used as a maximum-likelihood demand model">
</figure>
...
<figure>
  <img src="{{ '/images/Utility.png' | relative_url }}" alt="Utility function that subtracts price from baseline listing utility">
</figure>
...
<figure>
  <img src="{{ '/images/Probability.png' | relative_url }}" alt="Multinomial logit choice probability across listings in a room-size category">
</figure>
...
<figure>
  <img src="{{ '/images/Optimization.png' | relative_url }}" alt="Mixed-integer objective that maximizes expected revenue over listings and prices">
</figure>
...
<figure>
  <img src="{{ '/images/Constraint.png' | relative_url }}" alt="Optimization constraints on listing selection, prices, and category capacity">
</figure>
...
**More detail** (including the complete Python code and methodology) can be found in the [full project report (PDF)](https://kerryzl77.github.io/files/paper1.pdf). This project shows how advanced, data-driven techniques can support strategic decisions in the sharing economy. Keep an eye out for more enhancements, such as dynamic pricing extensions and richer demand modeling, coming soon!
